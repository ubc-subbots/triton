...
namespace triton_mission_planner
{
  ...
  GateIsVisible::GateIsVisible(const std::string& name, const BT::NodeConfig& config, MissionPlanner& rosnode) : SyncActionNode(name, config), mp_(rosnode)
  {}
  ...
  // BT::PortsList GateFind::providedPorts() { return {}; } //? may be needed?
  ...
  GateIsAligned::GateIsAligned(const std::string& name, const BT::NodeConfig& config, MissionPlanner& rosnode) : SyncActionNode(name, config), mp_(rosnode)
  {}
