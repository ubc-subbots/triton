...
public:
    ...
    Mat bound_gate_using_poles(vector<vector<Point>> hulls, Mat src)
    {
        ...
        Ptr<SVM> svm = SVM::load("/home/logan/Projects/underwater-object-detection/src/accuracyopencv_model.xml");
        vector<float> y_hat;
...
int main()
{
    ...
    GateDetector gatedtr = GateDetector(0.5, true, 400);

    src = cv::imread("/home/logan/Projects/underwater-object-detection/images/gate/3.jpg");
    /*
